...
Клиенты: ${clients.map(c => c.name).join(", ")}
Бренды: ДАРАД, ДАЛА НАН. Сорта: Высший сорт, Первый сорт. Фасовки: 5,10,25,50 кг.
Заявка: "${text}"
Верни JSON массив: [{"clientName":"...","brand":"...","grade":"...","bag_kg":50,"bags":10,"date":"YYYY-MM-DD"}]
Если дата не указана — завтра (${TOMORROW()}). Только JSON.`;
